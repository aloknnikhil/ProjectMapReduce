    ...
    private static void createZNode(String path, byte[] data, CreateMode createMode)    {
        ...
        try {
            if (getInstance().zooKeeper.exists(path, false) == null) {
                getInstance().zooKeeper.create(path,
